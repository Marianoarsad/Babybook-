# Graph Report - BabyBook+  (2026-08-09)

## Corpus Check
- 114 files · ~108,094 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 891 nodes · 1379 edges · 104 communities (65 shown, 39 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `396c13c0`
...
- [[_COMMUNITY_Shared Error Handling & Resource Factory|Shared Error Handling & Resource Factory]]
...
- [[_COMMUNITY_Blocking Alerts to Toast Redesign|Blocking Alerts to Toast Redesign]]
- [[_COMMUNITY_Mock-to-Real Backend Connection|Mock-to-Real Backend Connection]]
- [[_COMMUNITY_Graphify Query Vocabulary Expansion|Graphify Query Vocabulary Expansion]]
...
- [[_COMMUNITY_MemoryDetail.js|MemoryDetail.js]]
...
- [[_COMMUNITY_AllMemories.js|AllMemories.js]]
...
7. `seed()` - 15 edges
8. `expo` - 13 edges
9. `SectionContainerCard()` - 13 edges
10. `BabyBook+ — Project Guide for Claude Code` - 12 edges

## Surprising Connections (you probably didn't know these)
- `seed()` --indirect_call--> `row()`  [INFERRED]
  back-end/src/db/seedDemoYear.js → front-end/utils/pdfTemplate.js
- `QrScanner()` --references--> `expo-camera`  [EXTRACTED]
  front-end/components/QrScanner.js → front-end/package.json
...
Cohesion: 0.16
Nodes (22): EmptyStateCard(), ListEntryCard(), makeStyles(), MemoryVisualCard(), SectionContainerCard(), AboutApp(), makeStyles(), FAQS (+14 more)
...
Cohesion: 0.07
Nodes (29): dependencies, expo, expo-camera, expo-image-picker, expo-linear-gradient, @expo/metro-runtime, expo-notifications, expo-print (+21 more)

### Community 3 - "Back-End Package Manifest"
Cohesion: 0.12
Nodes (27): formatCapturedAt(), makeStyles(), ProfessionalView(), RecordsView(), Row(), Section(), SnapshotTimestamp(), QrCodeView() (+19 more)
...
Cohesion: 0.10
Nodes (20): ApiError, ALLOWED, { ApiError }, fileFilter(), fs, multer, path, publicUrlFor() (+12 more)

### Community 10 - "Nutrition Tracker Feature"
Cohesion: 0.08
Nodes (23): backgroundColor, adaptiveIcon, package, permissions, projectId, expo, android, extra (+15 more)
...
Cohesion: 0.22
Nodes (10): requireChildOwnership, { ApiError }, { createResourceRouter }, express, { requireAuth, requireChildOwnership }, RESOURCES, router, VALID_MILK (+2 more)
...
Cohesion: 0.29
Nodes (9): MainAppShell(), makeStyles(), ageText(), Dashboard(), dayDiff(), growthTrend(), makeStyles(), relativeTime() (+1 more)
...
Cohesion: 0.50
Nodes (4): DRAWER_WIDTH, makeStyles(), SECTIONS, SideMenu()
...
### Community 48 - "ThemeContext.js"
Cohesion: 0.20
Nodes (16): AppLoadingScreen(), makeStyles(), MESSAGES, Button(), makeVariants(), Field(), defaultValue, ThemeContext (+8 more)

### Community 49 - "CalendarView.js"
Cohesion: 0.24
Nodes (11): CalendarView(), CATEGORY_META, categoryColor(), makeStyles(), todayISO(), GeneralSettings(), LEAD_TIME_OPTIONS, makeStyles() (+3 more)

### Community 50 - "useToast"
Cohesion: 0.13
Nodes (17): EmptyChild(), ChangePassword(), makeStyles(), EditProfile(), makeStyles(), PREDEFINED_AVATARS, KIND, styles (+9 more)

### Community 51 - "api.js"
Cohesion: 0.24
Nodes (13): makeStyles(), PrivacySettings(), buildChildRecordsHtml(), exportChildRecordsPdf(), pdfExportAvailable(), buildRecordHtml(), calcAge(), CATEGORY_LABELS (+5 more)

### Community 52 - "Landing.js"
Cohesion: 0.29
Nodes (7): FEATURES, Landing(), makeStyles(), TRUST, Gradient(), breakpoints, useResponsive()

### Community 53 - "Services.js"
Cohesion: 0.16
Nodes (12): Auth(), makeStyles(), Services(), LanguagePreferences(), LANGUAGES, makeStyles(), LanguageContext, useLanguage() (+4 more)
...
### Community 55 - "DateField.js"
Cohesion: 0.39
Nodes (8): DateField(), inputBox(), pad(), parseValue(), PickerField(), TimeField(), toHM(), toISODate()

### Community 57 - "MemoryDetail.js"
Cohesion: 0.53
Nodes (4): ageAt(), makeStyles(), MemoryDetail(), prettyDate()

### Community 58 - "PhotoAttach.js"
Cohesion: 0.80
Nodes (3): PhotoAttach(), pickerAvailable(), pickImage()

### Community 59 - "Growth.js"
Cohesion: 0.67
Nodes (3): ageChecklists, Growth(), makeStyles()

### Community 61 - "GrowthChart.js"
Cohesion: 0.53
Nodes (5): GrowthChart(), makeStyles(), METRICS, monthLabel(), PAD
...
## Knowledge Gaps
- **447 isolated node(s):** `PAD`, `name`, `version`, `start`, `android` (+442 more)
...
- **Why does `seed()` connect `UI Component Library & Theming` to `api.js`, `Children Routes (CRUD)`, `Vercel Deployment Config`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `row()` connect `api.js` to `UI Component Library & Theming`?**
...
- **What connects `PAD`, `name`, `version` to the rest of the system?**
